...
knitr::kable(
  tabla_ind2,
  caption = "Tabla 2. Proporción de mujeres que toman decisiones informadas (%)"
)
```
...
knitr::kable(
  tabla_ind2,
  caption = "Tabla 3. Proporción de mujeres que toman decisiones informadas por área (%)"
)
```
*Fuente: CEPAL - Elaboración propia con base en la EDSA 2023 (Bolivia).*


### Figura 1. Mapa del Indicador número 2 desagregado por área geográfica
...
knitr::kable(
  tabla_ind2,
  caption = "Tabla 4. Proporcion de mujeres que toman decisiones informadas por etnia"
)
```
*Fuente: CEPAL - Elaboración propia con base en la EDSA 2023 (Bolivia).*

### Figura 2. Mapa del Indicador número 2 desagregado por étnia
...
```{r tabla-indicador2-5, echo=FALSE}
...
knitr::kable(
  tabla_ind2,
  caption = "Tabla 4. Proporción de mujeres que toman decisiones informadas por año de estudios (%)"
)
```
*Fuente: CEPAL - Elaboración propia con base en la EDSA 2023 (Bolivia).*

### Figura 3. Mapa del Indicador número 2 desagregado por años de estudio
...
tabla_ind2 <- readRDS(file.path(output, "Bol/indicator_3total.rds")) %>%
  rename(
